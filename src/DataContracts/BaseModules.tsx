...
export class ExternalApiCall {
 ...
 export class ContainerSetup {
    ...
    public ContractedHeight: number;
    ...
    constructor(WidgetId: number, ContainerId: string, ContractedHeight: number, ExpandedHeight: number, HasSetup: boolean, SupportEmail: string, SupportTel: string, SupportUrl: string){
